	...
	function (t) {
		...
		i.prototype.getDistance = function (t) {
			...
			i.prototype.getAbsoluteDistance = function (t, e, r) {
				...
				var o = 1,
					...
					u = 0,
					c = 0;
				for (n = r ? (t - this.xPct[i]) / (this.xPct[i + 1] - this.xPct[i]) : (this.xPct[i + 1] - t) / (this.xPct[i + 1] - this.xPct[i]); 0 < s;) a = this.xPct[i + 1 + c] - this.xPct[i + c],
		...
		function j(t, b, o) {
			var l, u, s, c, i, a, e, p, f = window.navigator.pointerEnabled ? {
				...
				d = window.CSS && CSS.supports && CSS.supports("touch-action", "none") &&
					function () {
						var t = !1;
						try {
			...
			function D(t, e) {
				...
				return V(n, b.cssClasses.touchArea),
					...
					b.keyboardSupport && (n.setAttribute("tabindex", "0"), n.addEventListener("keydown", function (t) {
						return function (t, e) {
							if (O() || L(e)) return !1;
							var r = ["Left", "Right"],
								n = ["Down", "Up"],
			...
			function K(t, e, r, n, i, o) {
				var s;
				return 1 < u.length && !b.events.unconstrained && (n && 0 < e && (s = y.getAbsoluteDistance(t[e - 1], b.margin, 0), r = Math.max(r, s)), i && e < u.length - 1 && (s = y.getAbsoluteDistance(t[e + 1], b.margin, 1), r = Math.min(r, s))),
			...
			return ht(e = h, b.cssClasses.target),
				...
				function (t, e) {
					...
					u = [],
						(s = []).push(M(r, t[0]));
					for (var n = 0; n < b.handles; n++) u.push(D(e, n)),
						m[n] = n,
						s.push(M(r, t[n + 1]))
				}(b.connect, l),
			...
			o ? (Y.set(e, i, !1), S.event.add(e, i, {
				...
				handler: function (e) {
					...
					if (1 & e.isTrigger && this[i]) {
						...
						else if (r = s.call(arguments), Y.set(this, i, r), t = o(this, i), this[i](), r !== (n = Y.get(this, i)) || t ? Y.set(this, i, !1) : n = {}, r !== n) return e.stopImmediatePropagation(),
							e.preventDefault(),
							n && n.value
